...
class RankedStatsTab extends StatefulWidget {
  const RankedStatsTab({super.key});

  @override
  State<RankedStatsTab> createState() => _RankedStatsTabState();
}

class _RankedStatsTabState extends State<RankedStatsTab> {
